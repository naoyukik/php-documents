 ...
 * @return resource eio_busy
 * は、成功した場合にリクエストリソースを返します。エラー時に FALSE を返します。eio_busyFALSE
 */
function eio_truncate($path, $offset, $pri = EIO_PRI_DEFAULT, $callback = NULL, $data = NULL) {}