/**
 * (^)<br/>
 * @link http://php.net/manual/en/sdo-das-relational.executequery.php
 ...
 */
function SDO_DAS_Relational.executeQuery($database_handle, $SQL_statement, $column_specifier) {}