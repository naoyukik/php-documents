 ...
 * @link http://php.net/manual/en/function.eio-rename.php
 * @param string $path [optional] <p> TODO DESCRIPTION </p>
 * @param string $new_path [optional] <p> TODO DESCRIPTION </p>
 ...
 * @return resource eio_rename
 * は、成功した場合にリクエストリソースを返します。エラー時に FALSE を返します。eio_renameFALSE
 */
