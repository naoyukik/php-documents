 ...
 * @param array $patterns_and_callbacks [optional] <p> TODO DESCRIPTION </p>
 ...
 * @return mixed preg_replace_callback_array は、
 * subject が配列の場合には配列を、
 * それ以外の場合は文字列を返します。
 * エラー時の返り値は NULL となります。preg_replace_callback_arraysubjectNULLマッチするものが見つかった場合は新しい subject
